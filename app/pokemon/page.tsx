      ...
      {selected && (
        ...
        >
          ...
          >
            ...
            <div
              className='absolute inset-0 w-full h-full bg-white rounded-2xl shadow-xl border-4 flex flex-col items-center justify-center p-4 backface-hidden overflow-hidden'
              style={{
